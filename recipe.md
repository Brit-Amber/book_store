...
class BookRepository
    ...
    def print_booklist
        #Returns puts of string of id - title - author_name
    end
end
```
...
books[0].author_name # =>  'Harper Lee'

books[1].id # =>  2
books[1].title # =>  'War and Peace'
books[1].author_name # =>  'Leo Tolstoy'

# 2
# Print list of books with id - title - author_name

repo = BookRepository.new
books = repo.all

self.all.print_booklist # => "1 - To Kill a Mockingbird - Harper Lee\n2 - War and Peace - Leo Tolstoy"
